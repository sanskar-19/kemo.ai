...
const HighlightsCard = ({ src, title, description }: CardProps) => {
  return (
    <Link href={`highlights/${title}`}>
      <article className='flex flex-col w-[20rem] h-full sm:w-[23rem] min-h-[21.25rem] rounded-lg shadow-highlights-card overflow-hidden transition-all cursor-pointer duration-300 hover:-translate-y-2'>
